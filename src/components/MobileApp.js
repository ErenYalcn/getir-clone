export default function MobileApp() {
    return (
     ...
     <div className="container flex items-center mx-auto justify-between bg-primary-brand-color bg-mobile-bg rounded-lg min-h-[312px] relative text-white">
        <div className="p-16 self-start mt-8">
           ...
           <div className="flex gap-2 mt-4 mt-9">
                        <a href="#">
