    ...
    return (
        <div className=" bg-white py-4">
            ...
            <div className="container grid gap-y-5 p-8 mx-auto">
                ...
                <div className="grid grid-cols-4 gap-x-6 2xl:grid-cols-5">
                    <nav>    
                    ...
                    <nav>
                    <h3 className="text-brand-color mb-4 text-xl mt-2">Getir'i Keşfedin!</h3>
                    <ul className="grid grid-cols-2 sm:grid-cols-1 gap-y-3 leading-3">
                        <li>
                    ...
                    <nav>
                        <h3 className="text-brand-color mb-4 text-xl mt-2">Yardıma mı ihtiyacınız var?</h3>
                            <ul className="grid grid-cols-2 sm:grid-cols-1 gap-y-3 leading-3">
                                <li>
                    ...
                    <nav>
                        <h3 className="text-brand-color mb-4 text-xl mt-2">İş Ortağımız Olun</h3>
                            <ul className="grid grid-cols-2 sm:grid-cols-1 gap-y-3 leading-3">
                                <li>
